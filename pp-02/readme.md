...
3. List the names of your group members here: Logan Wilcox, Randy Mai, Jarron Bailey, Zayaan Haider
...
Write the URL for your personal fork of the repository here: https://github.com/lwilcox/Project-2
...
group	git@github.com:SealTeam362/Project-2.git (fetch)
group	git@github.com:SealTeam362/Project-2.git (push)
origin	git@github.com:lwilcox/Project-2.git (fetch)
origin	git@github.com:lwilcox/Project-2.git (push)
